<script lang="ts">
    ...
    import type { CalendarEvent } from "$lib/types/event-types";
    import { parseEvent } from "$lib/utils/event-utils";
  
    // Parse the date strings into Date objects
    const parsedEvents: CalendarEvent[] = events.map(event => parseEvent(event));
  ...
  <main class="min-h-screen p-6 flex-1">
    ...
    <!-- Main content -->
    <div class="max-w-6xl mx-auto space-y-8 relative z-10" in:fly={{ y: -50, duration: 500, delay: 200 }}>
      <!-- Page title -->
