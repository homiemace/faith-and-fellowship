...
<div bind:this={card} class="transform transition-all duration-500 ease-out" class:translate-y-0={isVisible} class:opacity-100={isVisible} class:translate-y-4={!isVisible} class:opacity-0={!isVisible}>
