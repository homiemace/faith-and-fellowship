...
<div class="flex items-center justify-center space-x-6">
    <button 
        class="social-icon text-white hover:text-brand transition-all duration-300 rounded-full p-2.5" 
        on:click|preventDefault={onCodeClick} 
    ...
    <a 
        ...
        class="text-white hover:text-brand transition-all duration-200 text-3xl md:text-4xl rounded-full p-2.5" 
