...
<div class="flex items-center justify-center space-x-6">
    <button class="social-icon text-white hover:text-brand transition-all duration-300 rounded-full p-2.5" on:click|preventDefault={onCodeClick} aria-label="Copy code">
        <svg class="w-8 h-8 md:w-10 md:h-10" viewBox="0 0 79.82 79.98" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="https://www.instagram.com/417.faith.and.fellowship/" target="_blank" rel="noopener noreferrer" class="text-white hover:text-brand transition-all duration-200 text-3xl md:text-4xl rounded-full p-2.5" aria-label="Visit our Instagram">
